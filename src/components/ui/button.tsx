  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary-hover shadow-primary",
        ghost: "hover:bg-muted hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-success",
        forest: "gradient-forest text-primary-foreground hover:opacity-90 shadow-primary",
        ocean: "gradient-ocean text-secondary-foreground hover:opacity-90 shadow-primary",
        earth: "gradient-earth text-accent-foreground hover:opacity-90 shadow-success",
      },
      size: {
